                   ...
                   <input type="hidden" name="id" id="id">
                    ...
                    <div class="form-group">
                       ...
                       <label class="col-sm-2 control-label">Email</label>
                        <div class="col-sm-12">
                            <textarea id="email" name="email" required="" placeholder="Enter email1" class="form-control"></textarea>
                        </div>
                        
                    <div class="form-group">
                    <label class="col-sm-2 control-label">Request</label>
                        <div class="col-sm-12">
                            <textarea id="email1" name="email1" required="" placeholder="Enter email" class="form-control"></textarea>
                        </div>
