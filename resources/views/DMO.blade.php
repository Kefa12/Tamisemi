...
<div class="container register">                  
                ...
                <form method="GET" action="{{ url('add10') }}">
              
            @csrf
            <center><h1>District_Medical_Officer</h1>
                             <img src="assets3/img/logo2.jpg" alt="no image" width=180></center>
											  ...
											  <div class="col-md-6">
												   ...
												   <div class="form-group">
															...
															<select name="role_id"  class="form-control">
																   ...
																   <option value="DMO">District_Medical_Officer</option>
                               ...
                               <input type="hidden"  value="{{ __('DMO') }}"/>register
                                </button>
