...
<div class="col-xs-12 col-sm-12 col-md-12">
<div class="form-group">
    <input type="hidden" class="form-control" name="chospital" value="{{ Auth::user()->hospital }}"
        placeholder="Current_school"></input>
</div>
</div>
<div class="col-xs-12 col-sm-12 col-md-12">
...
<div class="card shadow mb-4">
              ...
              <div class="form-group">
													...
													<div class="form-group">
																	...
																	<div class="form-group">
																									   <h5 class="text-info  mb-4">Choose Hospital
																												<select  id="details" name="thospital"  style="width:250px;" class="form-control" disabled>
																												</select></h5>
																	</div>
																							   </div>
                                                                                               <div class="form-group">
