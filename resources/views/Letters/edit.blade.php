...
<h2> Swapping Nurse, {{ $letter->name }} </h2>
...
@if(!($letter->author==Auth::user()->name))
 ...
 <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="hidden" name="name" value="{{ Auth::user()->name }}" class="form-control" placeholder="Name">
                <input type="hidden" name="chospital" value="{{ Auth::user()->hospital }}" class="form-control" placeholder="Name">
    ...
    <input type="hidden" class="form-control" style="height:50px" name="cschool1" value="{{ Auth::user()->schools }}"
                    placeholder="mwenge"></input>
    <input type="hidden" class="form-control" style="height:50px" name="chospital" value="{{ Auth::user()->hospital }}"
                    placeholder="mwenge"></input>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="hidden" class="form-control" style="height:50px" name="tdistrict" value="{{$letter->cdistrict}}"
                    placeholder="iringa"></input>
                <input type="hidden" class="form-control" style="height:50px" name="thospital" value="{{ $letter->chospital }}"
                    placeholder="mwenge"></input>
            </div>
        </div>
    @csrf
 ...
 <input type="hidden" class="form-control" style="height:50px" name="cschool1" value="{{ $letter->cschool }}"
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="hidden" class="form-control" style="height:50px" name="schools" value="{{ $letter->tschool }}"
                    placeholder="mwenge"></input>
                <input type="hidden" class="form-control" style="height:50px" name="thospital" value="{{ $letter->thospital }}"
                    placeholder="mwenge"></input>
            </div>
        </div>
...
@endif
 ...
 <div class="form-group"  id="issues">
        ...
        <div class="row">
            ...
            <h2>Doctor Respond Request to Teacher {{ $letter->name }} </h2>
            <form action="{{ route('letters.update', $letter->id) }}" method="POST">
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                            <div class="form-group">
                                            <script>
 ...
 <div class="form-group"  id="issues">
     ...
     <form action="{{ route('letters.update', $letter->id) }}" method="POST">
        ...
        <input type="hidden" class="form-control" style="height:50px" name="statusi"    value="m"
            ...
            @endrole
            @if($letter->author==Auth::user()->name)
            @if($letter->Health_approved=='support BY nurse' || $letter->Health_approved=='Not_support BY nurse' || $letter->Health_approved=='pending')
            @role('Health_Worker')
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
             ...
             <input type="hidden" class="form-control" style="height:50px" name="Message"    value="SEND A REQUEST TRANSFER FOR EXACHANGE"
                       ></input>
            <input type="hidden" class="form-control" style="height:50px" name="status" value="nan"   
                       ></input>
    ...
    <input type="hidden" class="form-control" style="height:50px" name="author"  value="{{$letter->author}}"   
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">NURSE ACCEPTED
                <select name="Health_approved" class="block mt-1 w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm">
                        <option value="support BY nurse">ACCEPTED</option>
                        <option value="Not_support BY nurse">Not_accepted</option>
                </select>
                 </div>
                </div>
            </div>
       ...
       <div class="col-xs-12 col-sm-12 col-md-12">
            ...
            @role('Health_Worker')
            @if(!($letter->author==Auth::user()->name))
            <input type="hidden" name="status" value="Health"/>
            <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                <button type="submit" class="btn btn-primary">Submit</button>
            </div>
</div>
