        ...
        <div class="content">
            ...
            <!-- Sale & Revenue Start -->
              ...
              @foreach($letters as $letter)
                @if(auth::user()->regional==$letter->regional)
                  <input type="hidden" value="{{$data++}}"></input>
                @endif
              @endforeach
              @foreach($letters as $letter)
                @if((auth::user()->regional==$letter->regional) && ($letter->DED=="pending"))
                  <input type="hidden" value="{{$k++}}"></input>
                @endif
              @endforeach
              @foreach($letters as $letter)
                @if((auth::user()->regional==$letter->regional) && ($letter->author!="unknown"))
