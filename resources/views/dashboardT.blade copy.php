...
<x-app-layout>
  ...
  <div class="dropdown-content">
    <a href="{{ url('registe3') }}">HeadMaster</a>
    <a href="{{ url('registe4') }}">Ward_Education_Officer</a>
    <a href="{{ url('registe5') }}">District_Education_Officer</a>
    <a href="{{ url('registe6') }}">Regional_Education_Officer</a>
    <a href="{{ url('registe7') }}">Tamisemi_Director</a>
  </div>
</div>
